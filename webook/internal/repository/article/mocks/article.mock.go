...
//
//	mockgen -source internal\repository\article\article.go -destination internal\repository\article\mocks\article.mock.go -package repositorymocks
//
...
import (
	...
	domain "github.com/LXD-c/basic-go/webook/internal/domain"
