...
func (m *MockCodeService) Send(ctx context.Context, phone, biz string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", ctx, phone, biz)
	ret0, _ := ret[0].(error)
	return ret0
}

// Send indicates an expected call of Send.
func (mr *MockCodeServiceMockRecorder) Send(ctx, phone, biz any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockCodeService)(nil).Send), ctx, phone, biz)
}
